...
/**
 * Represents the JavaScript callback `(peerId: string, name: string) => void`.
...
fun interface Func_void_std__string_std__string: (String, String) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(peerId: String, name: String): Unit
}
...
class Func_void_std__string_std__string_cxx: Func_void_std__string_std__string {
  ...
  @Keep
  override fun invoke(peerId: String, name: String): Unit
    = invoke_cxx(peerId,name)

  @FastNative
  private external fun invoke_cxx(peerId: String, name: String): Unit
}
...
class Func_void_std__string_std__string_java(private val function: (String, String) -> Unit): Func_void_std__string_std__string {
  ...
  @Keep
  override fun invoke(peerId: String, name: String): Unit {
    return this.function(peerId, name)
  }
}
