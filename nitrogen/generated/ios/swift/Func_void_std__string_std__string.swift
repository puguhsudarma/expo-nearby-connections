...
/**
 * Wraps a Swift `(_ peerId: String, _ name: String) -> Void` as a class.
...
public final class Func_void_std__string_std__string {
  ...
  private let closure: (_ peerId: String, _ name: String) -> Void

  public init(_ closure: @escaping (_ peerId: String, _ name: String) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(peerId: std.string, name: std.string) -> Void {
    self.closure(String(peerId), String(name))
  }
