...
/**
 * Wraps a Swift `(_ peerId: String) -> Void` as a class.
...
public final class Func_void_std__string {
  ...
  private let closure: (_ peerId: String) -> Void

  public init(_ closure: @escaping (_ peerId: String) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(peerId: std.string) -> Void {
    self.closure(String(peerId))
  }
